...
void setup() {
    ...
    if (!digitalRead(12)) {
      ...
      voice.say(sp3_HOUR);
      delay(250);
      while (!digitalRead(12));  // wait until released
      RtcDateTime now = Rtc.GetDateTime();
      ...
      delay(500);      
      voice.say(sp2_SET);
      RtcDateTime new_date_time(now.Year(), now.Month(), now.Day(), new_hour, new_minute, 0);
